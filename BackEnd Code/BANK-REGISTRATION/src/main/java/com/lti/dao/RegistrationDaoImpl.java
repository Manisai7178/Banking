...
public class RegistrationDaoImpl implements RegistrationDao  {
	...
	public Register forRegistration(long accountNo) {
		String jpql="select s from Account where s.accountNo =: accountNo";
		TypedQuery<Account> tq = entityManager.createQuery(jpql,Register.class);
